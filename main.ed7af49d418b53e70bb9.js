 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const k=new class{handleAttributeExpressions(n,e,t){const i=e[0];return"."===i?new z(n,e.slice(1),t).parts:"@"===i?[new S(n,e.slice(1))]:"?"===i?[new E(n,e.slice(1),t)]:new v(n,e,t).parts}handleTextExpression(n){return new w(n)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function T(n,e,t=function(n){let e=C.get(n.type);void 0===e&&(e=new Map,C.set(n.type,e));let t=e.get(n.strings);return void 0===t&&(t=new p(n,n.getTemplateElement()),e.set(n.strings,t)),t}){let i=N.get(e);void 0===i&&(s(e,e.firstChild),N.set(e,i=new w(t)),i.appendInto(e)),i.setValue(n),i.commit()}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=(n,...e)=>new g(n,e,"html",k),V=[{label:"Bitrock",url:"https://bitrock.it"},{label:"Databiz",url:"https://databiz.it"},{label:"Radicalbit",url:"https://radicabit.io"}],L=n=>n.length?(n=>A`<div style="color:rgb(0,0,0);line-height:normal;font-family:Helvetica;font-size:11px">${n}</div>`)(n):"",F=n=>A`
      ...
      <div dir="ltr">
            ...
            <div>
              ...
              <div dir="ltr">
                ...
                <div style="color:rgb(0,0,0);line-height:normal;font-family:Helvetica;font-size:11px">
                  ...
                  ${(n=>n!==V[2].label?A`<div style="line-height:normal;font-size:10px"><b style="color:rgb(68,68,68);font-family:&quot;Calibri Light&quot;,sans-serif;font-size:11.3333px">
        ...
        <font color="#444444" style="color:rgb(68,68,68);font-family:&quot;Calibri Light&quot;,sans-serif;font-size:11.3333px">&nbsp;<a
            ...
            style="color:rgb(17,85,204)" target="_blank">– Viale della Repubblica 156</a>/A</font>
                  ...
                  ${(n=>{const e=V.filter(e=>e.label===n)[0];return A`<div style="line-height:normal;font-family:&quot;Calibri Light&quot;,sans-serif;color:rgb(68,68,68);font-size:11.3333px"><a
...
</div>`,R=n=>{const e=new CustomEvent("update-data",{detail:{key:n.target.name,value:n.target.value}});document.body.dispatchEvent(e)},I={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;","`":"&#x60;","=":"&#x3D;"},M=document.querySelector("#root"),O={firstname:"",lastname:"",role:"",email:"",phone:"",company:"Bitrock"},$=()=>A`
...
`,q=()=>{T($(),M);const n=document.querySelector("pre code"),e=document.querySelector("#preview div");n.innerHTML=(n=>String(n).replace(/[&<>"'`=\/]/g,n=>I[n]))(e.innerHTML)};document.body.addEventListener("update-data",n=>{const e=n.detail;O[e.key]=e.value,console.log(n.detail,O),q()}),q(),console.log("Project started..."),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").then(n=>{console.log("SW registered: ",n)}).catch(n=>{console.log("SW registration failed: ",n)})}),document.querySelector(".js-warning").style.display="none"}]);
//# sourceMappingURL=main.ed7af49d418b53e70bb9.js.map